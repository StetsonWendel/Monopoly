    ...
    renderBoard() {
        ...
        container.innerHTML = `
          ...
          <div id="turn-modal" style="display:none; position:fixed; left:0; top:0; width:100vw; height:100vh; background:rgba(0,0,0,0.4); align-items:center; justify-content:center; z-index:4000;">
            ...
            <div id="card-modal" style="display:none; position:fixed; left:0; top:0; width:100vw; height:100vh; background:rgba(0,0,0,0.4); align-items:center; justify-content:center; z-index:5000;">
                <div style="background:#fff; border-radius:12px; box-shadow:0 4px 32px #0008; padding:32px 28px; min-width:320px; min-height:120px; position:relative; text-align:center;">
                    <img id="card-modal-img" src="" alt="Card" style="max-width:220px; display:block; margin:0 auto 16px auto;">
                    <div id="card-modal-text" style="font-size:1.2em; margin-bottom:18px;"></div>
                    <button id="card-modal-close" style="min-width:80px;">OK</button>
                </div>
            </div>
            <div id="debug-dice-modal" style="display:none; position:fixed; left:0; top:0; width:100vw; height:100vh; background:rgba(0,0,0,0.4); align-items:center; justify-content:center; z-index:9999;">
              <div style="background:#fff; padding:24px; border-radius:8px;">
                <label>Die 1: <input id="debug-die1" type="number" min="1" max="6" value="1"></label><br>
                <label>Die 2: <input id="debug-die2" type="number" min="1" max="6" value="1"></label><br>
                <label>Mega: <input id="debug-mega" type="text" value="1"></label><br>
...
module.exports = RenderMonopolyGame;